...
public class PvPScene2 extends Scene {
...
//   private int mapHeight = 2170;
   ...
   private int pY;
    ...
    public void sceneBegin() {
        ...
        cArr.add(new Chicken(800, 560, Global.UNIT_X, Global.UNIT_Y));
...
//        cameraArr.add(new Camera.Builder(Global.SCREEN_X , Global.SCREEN_Y)
        ...
        smallMap = new SmallMap(
                ...
                .setCameraWindowLocation(500, 550)
...
//     seperate line
        ...
        for (int i = 0; i < beltArr.size(); i++) {
            smallMap.paint(g, beltArr.get(i), Color.LIGHT_GRAY);
        }
        for (int i = 0; i < pArr.size(); i++) {
            smallMap.paint(g, pArr.get(i), Color.LIGHT_GRAY);
        }
        for (int i = 0; i < gArr.size(); i++) {
...
//    	                  tmp.setState(THROB, PopsAnimator.State.EXPLODE);
    ...
    private void mapInitialize() { //地圖載入
        try {
            ...
            Logger.getLogger(PvPScene2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
